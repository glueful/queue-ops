...
namespace Glueful\Extensions\QueueOps\Tests\Unit\Schema;

use Glueful\Extensions\QueueOps\Schema\QueueOpsSchemaVerifier;
...
final class SchemaManifestTest extends TestCase
{
    ...
    public function testVerifierClassConformsToTheManifestContract(): void
    {
        ...
        self::assertSame('glueful/queue-ops', (new $class())->source());
    }

    public function testVerifierCoversEveryRecursivelyDiscoveredMigration(): void
    {
        $mapped = (new QueueOpsSchemaVerifier())->migrationBasenames();
    ...
    {
        $g = $this->manifest();
        $candidates = ['glueful/queue-ops' => new \Glueful\Extensions\ExtensionCandidate(
        ...
        self::assertSame([], $result->errors, 'queue-ops must resolve enabled-alone');
    }

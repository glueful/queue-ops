...
namespace Glueful\Extensions\QueueOps\Tests\Integration\Schema;
...
final class SchemaVerifierBehaviorTest extends TestCase
{
    ...
    private QueueOpsSchemaVerifier $verifier;
    private string $dbPath;

    protected function setUp(): void
    {
        $this->dbPath = sys_get_temp_dir() . '/queue-ops-verify-' . uniqid('', true) . '.sqlite';
        ...
        $this->verifier = new QueueOpsSchemaVerifier();
    }
